...
class AppAlertComponent extends imba_Component {
	...
	render(){
		...
		($10=$11=1,$8=$3[$9]) || ($10=$11=0,$3[$9]=$8=imba_createElement('div',$3,`x7znbb-ag alert ${$7}`,null));
		($13=this.color,$13===$3[$12] || ($8.css$var('--x7znbb_ah',$3[$12]=$13,null,'bdt')));
		($16=$17=1,$14=$3[$15]) || ($16=$17=0,$3[$15]=$14=imba_createElement('i',$8,`x7znbb-ai fal ${$7}`,null));
		($20=`fa-${this.icon}`,$20===$3[$19]||($17|=2,$3[$19]=$20));
		($20=this.color,$20===$3[$21] || ($14.css$var('--x7znbb_aj',$3[$21]=$20,null,'c')));
		($17&2 && $14.flag$(`x7znbb-ai fal ${$7}`+' '+($3[$19]||'')));
		;
		($22=$3[$23]) || ($3[$23]=$22=imba_createElement('div',$8,`x7znbb-ak ${$7}`,null));
		$24 = null;
		if (this.title) { ($26=$27=1,$24=$3[$25]) || ($26=$27=0,$3[$25]=$24=imba_createElement('div',null,`x7znbb-al ${$7}`,null));
		$26||($24[$$up$]=$22);
		($28=this.title,($28===$24[$30]&&$26) || ($24[$29] = $24[$placeChild$]($24[$30]=$28,384,$24[$29])));
		 };
		($3[$31] = $22[$placeChild$]($24,0,$3[$31]));
		($32=$3[$33]) || ($3[$33]=$32=imba_createElement('div',$22,`x7znbb-am ${$7}`,null));
		...
		if (this.showClose) {
			...
			($39=$40=1,$37=$3[$38]) || ($39=$40=0,$3[$38]=$37=imba_createElement('button',null,`x7znbb-an ${$7}`,null));
			$39||($37[$$up$]=$8);
			$39 || ($37.on$(`click`,{$_: [function(e,$$) {
				return this.closest('.alert').remove(e);
			}]},this));
			$39 || ($41=imba_createElement('i',$37,`x7znbb-ao fal fa-times ${$7}`,null));
			;
...
.x7znbb-ai:not(#_):not(#_):not(#_) {font-size: 0.9rem;
color: var(--x7znbb_aj);
--t_y: 1px !important;}

.x7znbb-ak:not(#_):not(#_):not(#_) {display: flex;
...
.x7znbb-al:not(#_):not(#_):not(#_) {font-weight: 600;}

.x7znbb-am:not(#_):not(#_):not(#_) {color: hsla(240.00,5.20%,33.92%,100%);}

.x7znbb-an:not(#_):not(#_):not(#_) {padding: 0rem;
background: hsla(0.00,0.00%,100.00%,0%);
cursor: pointer;}

.x7znbb-ao:not(#_):not(#_):not(#_) {color: hsla(240.00,3.83%,46.08%,100%);
--t_y: 1px !important;}
